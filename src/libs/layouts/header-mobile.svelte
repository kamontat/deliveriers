  ...
  {:else}
    <div class="flex flex-col mx-2 my-3">
      ...
      <div class="flex flex-col">
        <input
          class="py-1 px-2 my-2 rounded-md text-gray-900 outline-none border border-gray-300 focus:border-red-600"
          type="text"
          placeholder="Enter your email"
          bind:value={email}
        />
        <input
          class="py-1 px-2 my-2 rounded-md text-gray-900 outline-none border-2 border-gray-300 focus:border-red-600"
          type="password"
